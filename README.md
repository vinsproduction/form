...
numeric | значение или true | Разрешены только цифры
alpha | значение или true  | Разрешены только буквы
eng | значение или true  | Разрешены только английские буквы
rus | значение или true  | Разрешены только русские буквы
